...
import { Heart, Activity, Brain, Shield, Database, Sparkles, TrendingUp, Users, Clock, ArrowRight, CheckCircle2, Zap, Bot, Smartphone } from 'lucide-react';
...
const capabilities = [
  { text: 'Strategy & Planning', icon: <CheckCircle2 className="w-5 h-5" /> },
  { text: 'Product Design & UX', icon: <CheckCircle2 className="w-5 h-5" /> },
  { text: 'Full-Stack Development', icon: <CheckCircle2 className="w-5 h-5" /> },
  { text: 'AI Integration', icon: <CheckCircle2 className="w-5 h-5" /> },
  { text: 'Compliance & Security', icon: <CheckCircle2 className="w-5 h-5" /> },
  { text: 'Growth & Optimization', icon: <CheckCircle2 className="w-5 h-5" /> }
];
          ...
          <div className="relative z-10 container mx-auto px-4 py-32">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/30 mb-6">
                ...
                <span className="text-blue-100 text-sm font-medium">Health & Wellness Expertise</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/contact"
                  className="px-8 py-4 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-all flex items-center gap-2 group"
                >
                ...
                <a
                  href="#projects"
                  className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-lg font-medium hover:bg-white/20 transition-all border border-white/20"
                >
                  View Projects
                </a>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
                ...
                <div className="border-l-2 border-yellow-400 pl-4">
                  ...
                  <div className="text-white/70 text-sm">Typical Build</div>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-4">
                  ...
                  <span className="text-blue-600 text-sm font-medium">Technical Capabilities</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                  What We've Built in Health
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  From AI agents analyzing blood scans to enterprise wellness platforms serving 60K+ users—
                  here's the technology we've shipped in production.
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    description: 'Voice-powered conversational AI (11Labs), Claude Vision for food label scanning, GPT-4o for health guidance',
                    tags: ['OpenAI', '11Labs', 'Claude Vision']
                  },
                  {
                    icon: <Activity className="w-6 h-6" />,
                    title: 'Wearable Data Integration',
                    description: 'Real-time sync with Apple Health, Oura Ring, Whoop, Fitbit, Strava—unified health profiles across devices',
                    tags: ['Apple Health', 'Oura', 'Whoop']
                  },
                  {
                    icon: <Database className="w-6 h-6" />,
                    title: 'Evidence Engine™',
                    description: 'Vector embeddings for semantic search across clinical trials, product databases, and peer-reviewed research',
                    tags: ['RAG', 'Vector Search', 'PostgreSQL']
                  },
                  {
                    icon: <Sparkles className="w-6 h-6" />,
                    title: 'SaaS Health Platforms',
                    description: 'Multi-tenant architectures, serverless edge functions, auto-scaling from 1K to 100K+ users with zero DevOps',
                    tags: ['Supabase', 'Edge Functions', 'Serverless']
                  },
                  {
                    icon: <Smartphone className="w-6 h-6" />,
                    title: 'Fitness Mobile Apps',
                    description: 'Cross-platform React Native apps with offline-first architecture, real-time sync, and social features',
                    tags: ['React Native', 'Mobile-First', 'PWA']
                  },
                  {
                    icon: <Brain className="w-6 h-6" />,
                    title: 'Mental Health AI Training',
                    description: 'Personalized mindfulness programs, sentiment analysis, mental health tracking with privacy-first design',
                    tags: ['AI Training', 'Privacy', 'Analytics']
                  },
                  {
                    icon: <Shield className="w-6 h-6" />,
                    title: 'Clinical Management Systems',
                    description: 'HIPAA-compliant patient records, AI scheduling optimization, automated reminders, EHR integration',
                    tags: ['HIPAA', 'Scheduling', 'EHR']
                  },
                  {
                    icon: <Users className="w-6 h-6" />,
                    title: 'Corporate Wellness Platforms',
                    description: 'Enterprise health platforms serving 60K+ users across 30+ countries with team challenges and gamification',
                    tags: ['Enterprise', 'Gamification', 'Scale']
                  },
                  {
                    icon: <TrendingUp className="w-6 h-6" />,
                    title: 'Health Data Analytics',
                    description: 'Real-time dashboards, predictive health insights, trend analysis, and actionable recommendations',
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white p-6 rounded-xl border-2 border-gray-100 hover:border-blue-300 hover:shadow-lg transition-all group"
                  >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {healthProjects.map((project, index) => (
                  ...
                  >
                    <Link
                      to={project.url}
                      className="block bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all group"
                    >
                      {/* Image */}
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
                {capabilities.map((capability, index) => (
                  ...
                  >
                    <span className="text-green-400">{capability.icon}</span>
              ...
              >
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-all group text-lg"
                >
