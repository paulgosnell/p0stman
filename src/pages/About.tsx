        ...
        <section className="relative min-h-[80vh] flex items-center bg-white text-gray-900">
          ...
          <div className="container mx-auto px-4 py-24 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="mb-6">
                  <span className="text-blue-600 font-medium text-lg">About P0STMAN</span>
                </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              >
                <h2 className="text-4xl font-thin mb-6 text-gray-900">Our Core Values</h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {values.map((value, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-light text-gray-900 mb-3">{value.title}</h3>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-4xl font-thin mb-8 text-gray-900">What We Do</h2>
                  ...
                  <div className="space-y-6 mb-12">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-light text-gray-900 mb-2">Rapid Development</h3>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-light text-gray-900 mb-2">AI Innovation</h3>
                        <p className="text-gray-600">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-light text-gray-900 mb-2">Strategic Partnership</h3>
                        <p className="text-gray-600">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-light text-gray-900 mb-2">Measured Results</h3>
                        <p className="text-gray-600">
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-12 border border-gray-200">
