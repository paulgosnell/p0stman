        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-20 right-0 left-0 md:right-6 md:left-auto md:w-80 bg-white border border-gray-100 shadow-lg z-50 overflow-hidden md:rounded-xl"
              onClick={() => setIsOpen(false)}
            >
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className="group relative block p-3 rounded-lg hover:bg-gray-50 transition-all duration-200"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <span className="text-gray-900 font-light group-hover:text-blue-600 transition-colors">
                                {item.label}
                              </span>
                              <motion.div
