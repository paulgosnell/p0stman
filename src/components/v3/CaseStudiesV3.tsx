...
export default function CaseStudiesV3() {
  ...
  const caseStudyCards = shuffledCaseStudies.map((study) => (
    <a
      key={study.id}
      href={
      ...
      className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 bg-white dark:bg-gray-800 flex flex-col hover:-translate-y-2 cursor-pointer h-full"
    >
      {/* Project Image */}
