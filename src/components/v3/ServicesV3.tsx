...
export default function ServicesV3() {
  const stepCards = processSteps.map((step, index) => (
    <motion.div
      key={index}
    ...
    <section id="services" className="py-48 md:py-52 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-20 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent z-0" />
