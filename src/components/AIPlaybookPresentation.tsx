...
const AIPlaybookPresentation: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen relative flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-8 max-w-6xl">
          ...
          <div className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <ChevronDownIcon className="w-8 h-8 mx-auto animate-bounce text-gray-500" />
          </div>
        </div>
      </section>
      ...
      {/* Infrastructure & Compute Section */}
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                <ComputeMetric 
                  before="345MW"
                  after="854MW"
                  label="UAE Compute Capacity"
                />
                <ComputeMetric 
                  before="429MW"
                  after="841MW"
                  label="Saudi Compute Growth"
                />
              </div>
              <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-8 rounded-2xl border border-gray-800">
                <h3 className="text-2xl font-light mb-4 text-purple-300">HUMAIN Initiative</h3>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Saudi Arabia's PIF launched HUMAIN in May 2025 with 18,000 Blackwell GPUs, 
                  establishing the region as a global AI compute powerhouse.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative bg-gray-900/80 p-8 rounded-3xl border border-gray-700">
                <div className="text-center">
                  <div className="text-5xl font-thin text-blue-400 mb-4">18,000</div>
                  <div className="text-xl text-gray-300">Blackwell GPUs</div>
                  <div className="text-sm text-gray-500 mt-2">HUMAIN Infrastructure</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-orange-900/20 to-red-900/20 p-8 rounded-2xl border border-gray-800">
                  <h3 className="text-2xl font-light mb-4 text-orange-300">Scalable Power</h3>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Strategic energy expansion aligned with AI infrastructure demands, 
                    positioning the region for sustainable compute growth.
                  </p>
                </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-900/80 to-black/80 p-12 rounded-3xl border border-gray-800">
                ...
                <div className="mt-6 text-sm text-gray-500">Reuters Interview</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-8 py-20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-16 text-center">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-12 py-4 rounded-full text-xl font-medium transition-all duration-300 transform hover:scale-105">
...
const ComputeMetric: React.FC<{ before: string; after: string; label: string }> = ({ before, after, label }) => (
...
const ActionItem: React.FC<{ quarter: string; title: string }> = ({ quarter, title }) => (
  <div className="group cursor-pointer">
    <div className="bg-gradient-to-br from-gray-900/80 to-black/80 p-6 rounded-2xl border border-gray-800 group-hover:border-gray-700 transition-all duration-300 group-hover:transform group-hover:scale-105">
...
export default AIPlaybookPresentation;