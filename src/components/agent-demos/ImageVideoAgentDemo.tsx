      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80 text-xs font-medium">{current.type}</span>
          </div>

          {/* Processing visualization */}
          <div className="grid grid-cols-3 gap-2 items-center">
            {/* Input */}
            <div className="col-span-1 p-2 bg-white/5 rounded border border-white/10">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-white/50">{current.output}</p>
          </div>
        </motion.div>
      </AnimatePresence>
    </div>
