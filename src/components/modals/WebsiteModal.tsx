...
import { X, Globe, Clock, CheckCircle, Loader2, Twitter, Mail, Bot, Zap } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/50">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Custom Website Package</h2>
            </div>
              ...
              <div className="space-y-8">
                <div className="bg-purple-50 p-6 rounded-xl">
                  ...
                  <p className="text-gray-600 mb-4">
                    Get a professional website built in 2 weeks using cutting-edge AI technology.
                  </p>
                  <div className="flex items-center gap-2 text-purple-600">
                    <Zap className="w-4 h-4" />
                    <span className="text-sm font-medium">30 days of post-launch support included</span>
                  </div>
                </div>
