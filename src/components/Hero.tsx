          ...
          >
            ...
            <div className="relative z-10 p-12">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-white">Building the Future with AI</h2>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 flex items-center">
                  <p className="text-gray-300 text-lg">
                    I build and scale digital ventures, fast. As a leading Bolt power user and ambassador, I leverage the world's most advanced AI development platform to deliver exceptional results. 
                  </p>
                </div>
