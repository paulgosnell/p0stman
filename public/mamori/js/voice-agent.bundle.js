var MamoriVoice = (() => {
  ...
  var init_livekit_client_esm = __esm({
    "node_modules/livekit-client/dist/livekit-client.esm.mjs"() {
      ...
      h = (i2, s2, t) => s2 in i2 ? e(i2, s2, {
        enumerable: true,
        configurable: true,
        writable: true,
        value: t
      }) : i2[s2] = t;
      o = (i2, s2, t) => h(i2, typeof s2 != "symbol" ? s2 + "" : s2, t);
      _ = class {
        constructor() {
          o(this, "_locking");
          o(this, "_locks");
              ...
              try {
                ...
                const abortHandler = (event) => __awaiter(this, void 0, void 0, function* () {
                  if (this.streamWriter) {
                    this.sendLeave().then(() => this.close()).catch((e2) => {
                      this.log.error(e2);
                      this.close();
                    });
                  } else {
  ...
  var i, r2, c, u, h2, m, f, y, _2, S, M, I, D, F, A, P;
...
`);
      _2 = class __ extends c {
        ...
        static async create(n) {
          ...
          const c2 = new Room();
          try {
            const e2 = `room_${Date.now()}`, a2 = l("pcm_48000"), s3 = l("pcm_48000"), i3 = new __(c2, e2, a2, s3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
            var d2;
      ...
      S = class _S extends r2 {
        static async startSession(e2) {
          ...
          let n = null;
          try {
            return await C(t.connectionDelay), n = await k(e2), new _S(t, n);
          } catch (e3) {
            var o2;
      ...
      M = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
      I = class _I {
  ...
  // js/voice-agent-bundled.js
  var require_voice_agent_bundled = __commonJS({
    "js/voice-agent-bundled.js"() {
      init_lib_modern();
      var MamoriVoiceAgent = class {
        constructor(config) {
          this.config = config;
          this.isActive = false;
        ...
        async start() {
          ...
          try {
            ...
            this.conversation = await P.startSession({
              agentId: this.config.agentId,
            ...
            if (typeof this.conversation.getOutputByteFrequencyData === "function") {
              try {
                ...
                if (frequencyData && frequencyData.length > 0) {
                  ...
                  this.bars.forEach((bar, i2) => {
                    const value = frequencyData[i2 * step] || 0;
                    const height = this.isSpeaking ? Math.max(value / 255 * 100, 4) : 4;
  ...
  return require_voice_agent_bundled();
})();
